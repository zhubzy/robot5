	...
	function preload() 
	{
		bot1 = loadImage("Images/robot1.svg"); 
		bot2 = loadImage("Images/robot2.svg"); 
		bot3 = loadImage("Images/robot3.svg"); 
		landscape = loadImage("Images/alpine.png");
	}
	...
	function draw() {
		// Set the background to the "landscape" image; this image // must be the same width and height as the program background(landscape);
		background(landscape);
		// Set the left/right offset and apply easing to make // the transition smooth
		var targetOffset = map(mouseY * 2, 0, height, -40, 40); 
